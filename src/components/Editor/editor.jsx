...
import injectImageFootnote from './summernote-plugin-image-footnote';
import injectImagesizeX from './summernote-plugin-imagesize-x';
import injectFloatX from './summernote-plugin-float-x';
import injectRemoveMediaX from './summernote-plugin-remove-media-x';
import injectColorX from './summernote-plugin-color-x';
...
class ReactSummernote extends Component {
  ...
  componentDidMount() {
    ...
    // inject plugin to summernote
    const Summernote = $.summernote;
    injectImageFootnote(Summernote);
    injectImagesizeX(Summernote);
    injectFloatX(Summernote);
    injectRemoveMediaX(Summernote);
    injectColorX(Summernote);
