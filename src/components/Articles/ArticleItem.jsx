...
class ArticleItem extends React.Component {
  ...
  handleSetSelected = () => {
    this.props.articlesStore.setSelected(this.props.article);
  };
  ...
  handlePublish = () => {
    this.props.articlesStore.setStatusAsPublished(this.props.article);
  };

  handlePullOff = () => {
    this.props.articlesStore.setStatusAsPullOffed(this.props.article);
  };

  handleRemove = () => {
    this.props.articlesStore.deleteOne(this.props.article);
  };

  render() {
    const { article, articlesStore } = this.props;
    ...
    const cover = article.thumbnail.toJS()[0] || imagePlaceholder;
              ...
              {isPublished ? (
                isSelected ? (
                  <Trigger
                    ...
                    disabled={articlesStore.isProgress}
                  >
              ...
              {isPublished && (
                <InlineContainer>
                  ...
                  <Modal
                    ...
                    confirmLoading={articlesStore.isProgress}
