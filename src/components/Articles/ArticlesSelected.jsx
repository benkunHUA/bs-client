...
class ArticlesSelected extends React.Component {
  componentDidMount() {
    this.props.articlesStore.reset();
    this.props.articlesStore.setCurrentSelected(1);
    this.props.articlesStore.loadArticles();
  }

  handleSetCurrentPage = page => {
    this.props.articlesStore.setCurrentPage(page);
    this.props.articlesStore.loadArticles();
  };
  ...
  handleDragEnd = result => {
    ...
    this.props.articlesStore.swapStickPosition(sp1, sp2);
    this.props.articlesStore.loadArticles();
  };
